    ...
    <nav>
      <div className="nav">
        ...
        <div className="categories desktop">
          <button onClick={() => handleCategoryClick("mens")} className="cate">Mens</button>
          <button onClick={() => handleCategoryClick("womens")} className="cate">Womens</button>
          <button onClick={() => handleCategoryClick("childern")} className="cate">Children</button>
          <button onClick={() => handleCategoryClick("")} className="cate">All</button>
        </div>
          ...
          {showDropdown && (
            <div className="dropdown">
              {user ? (
                <>
                  <span>{user.username}</span>
                  <button onClick={() => { logout(); setShowDropdown(false); }} className="logout-btn">Logout</button>
                </>
              ) : (
                <>
                  <Link to="/login" className="dropdown-link" onClick={() => setShowDropdown(false)}>Login</Link>
                  <Link to="/signup" className="dropdown-link" onClick={() => setShowDropdown(false)}>Signup</Link>
                </>
              )}
            </div>
          )}
